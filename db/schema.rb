...
ActiveRecord::Schema[8.1].define(version: 2026_07_29_100623) do
  ...
  create_table "groupings", force: :cascade do |t|
    ...
    t.bigint "mandataire_market_application_id", null: false
    t.string "mandataire_siret", null: false
    t.bigint "public_market_id", null: false
    t.datetime "updated_at", null: false
    t.index ["mandataire_market_application_id"], name: "index_groupings_on_mandataire_market_application_id"
    t.index ["public_market_id", "mandataire_market_application_id"], name: "index_groupings_on_market_and_mandataire", unique: true
    t.index ["public_market_id", "mandataire_siret"], name: "index_groupings_on_market_and_mandataire_siret", unique: true
  ...
  add_foreign_key "groupings", "market_applications", column: "mandataire_market_application_id"
