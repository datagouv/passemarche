...
class CsvRowData
  ...
  SUPPORTED_TYPES = %w[checkbox checkbox_with_document document email file_or_textarea phone textarea texte capacite_economique_financiere_chiffre_affaires_global_annuel capacite_economique_financiere_effectifs_moyens_annuels presentation_intervenants capacites_techniques_professionnelles_effectifs_cv_intervenants].freeze
