...
class MarketAttributeResponse::CapaciteEconomiqueFinanciereEffectifsMoyensAnnuelsComponentPreview < Lookbook::Preview
  # @label Form - Empty
  ...
  def display_web_empty
    ...
    render MarketAttributeResponse::CapaciteEconomiqueFinanciereEffectifsMoyensAnnuelsComponent.new(
