...
module MarketAttributeResponse
  class CapaciteEconomiqueFinanciereChiffreAffairesGlobalAnnuelComponentPreview < Lookbook::Preview
    # @label Form - Empty
    ...
    def display_web_empty
      ...
      render CapaciteEconomiqueFinanciereChiffreAffairesGlobalAnnuelComponent.new(
    ...
    def render_with_form(response)
      ...
      render_inline(CapaciteEconomiqueFinanciereChiffreAffairesGlobalAnnuelComponent.new(
        market_attribute_response: response,
