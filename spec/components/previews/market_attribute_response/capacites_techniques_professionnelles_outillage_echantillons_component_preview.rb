...
module MarketAttributeResponse
  class CapacitesTechniquesProfessionnellesOutillageEchantillonsComponentPreview < Lookbook::Preview
    # @label Form - Empty
    ...
    def display_web_empty
      ...
      render CapacitesTechniquesProfessionnellesOutillageEchantillonsComponent.new(
    ...
    def render_with_form(response)
      ...
      render_inline(CapacitesTechniquesProfessionnellesOutillageEchantillonsComponent.new(
        market_attribute_response: response,
