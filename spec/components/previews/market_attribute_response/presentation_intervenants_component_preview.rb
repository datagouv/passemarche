...
module MarketAttributeResponse
  class PresentationIntervenantsComponentPreview < Lookbook::Preview
    # @label Form - Empty
    ...
    def display_web_empty
      ...
      render PresentationIntervenantsComponent.new(
    ...
    def render_with_form(response)
      ...
      render_inline(PresentationIntervenantsComponent.new(
        market_attribute_response: response,
