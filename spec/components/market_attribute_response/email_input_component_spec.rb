...
RSpec.describe MarketAttributeResponse::EmailInputComponent, type: :component do
  let(:market_attribute) { create(:market_attribute, :email, :mandatory, key: 'contact_email') }

  describe '#text_value' do
    context 'with text present' do
      it 'returns the text value' do
        response = create(:market_attribute_response_email_input, market_attribute:, value: { 'text' => 'test@example.com' })
        component = described_class.new(market_attribute_response: response)

        expect(component.text_value).to eq('test@example.com')
      end
    end

    context 'with text blank' do
      it 'returns empty string' do
        response = build_stubbed(:market_attribute_response_email_input, market_attribute:, value: { 'text' => '' })
        component = described_class.new(market_attribute_response: response)
    ...
    context 'with nil value' do
      it 'returns empty string' do
        response = create(:market_attribute_response_email_input, market_attribute:, source: :auto, value: nil)
        component = described_class.new(market_attribute_response: response)
  ...
  describe '#display_value' do
    context 'with text present' do
      it 'returns the text value' do
        ...
        expect(component.display_value).to eq('test@example.com')
      end
    end
  ...
  describe 'form mode' do
    ...
    context 'with manual source' do
      it 'renders input group with email field' do
        response = create(:market_attribute_response_email_input, market_attribute:, source: :manual, value: { 'text' => 'test@example.com' })
        ...
        allow(response_form).to receive(:email_field).and_return('<input type="email">'.html_safe)
    ...
    context 'with auto source' do
      it 'renders hidden fields only' do
        response = create(:market_attribute_response_email_input, market_attribute:, source: :auto, value: { 'text' => 'auto@example.com' })
        component = described_class.new(market_attribute_response: response, form:)
        ...
        expect(response_form).to have_received(:hidden_field).with(:text, hash_including(value: 'auto@example.com'))
      end
    ...
    context 'with manual_after_api_failure source' do
      it 'renders input group with email field' do
        response = create(:market_attribute_response_email_input, market_attribute:, source: :manual_after_api_failure, value: { 'text' => 'fallback@example.com' })
        component = described_class.new(market_attribute_response: response, form:)
    ...
    context 'with errors' do
      it 'adds error CSS classes to input group' do
        response = build_stubbed(:market_attribute_response_email_input, market_attribute:, source: :manual, value: { 'text' => 'invalid' })
        response.errors.add(:text, 'Format email invalide')
        component = described_class.new(market_attribute_response: response, form:)
  ...
  describe 'display mode' do
    context 'with manual source and web context' do
      it 'shows field label and value' do
        response = create(:market_attribute_response_email_input, market_attribute:, source: :manual, value: { 'text' => 'contact@example.com' })
        ...
        expect(page).to have_text('contact@example.com')
      end
    end
    ...
    context 'with auto source and web context' do
      it 'shows field label but hides value' do
        ...
        expect(page).to have_css('div.field-layout-container')
        expect(page).to have_css('strong')
        expect(page).not_to have_text('auto@example.com')
      end
    ...
    context 'with auto source and buyer context' do
      it 'shows field label and value for buyer' do
        ...
        expect(page).to have_text('auto@example.com')
      end
    end
    ...
    context 'with empty value' do
      it 'displays "Non renseigné"' do
        response = build_stubbed(:market_attribute_response_email_input, market_attribute:, source: :manual, value: { 'text' => '' })
        component = described_class.new(market_attribute_response: response, context: :web)
  ...
  describe '#errors?' do
    it 'returns true when errors present' do
      response = build_stubbed(:market_attribute_response_email_input, market_attribute:, value: { 'text' => 'invalid' })
    ...
    it 'returns false when no errors' do
      response = create(:market_attribute_response_email_input, market_attribute:, value: { 'text' => 'valid@example.com' })
      component = described_class.new(market_attribute_response: response)
