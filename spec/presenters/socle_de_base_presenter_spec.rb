...
RSpec.describe SocleDeBasePresenter do
  ...
  describe '#buyer_description' do
    context 'when description exists' do
      ...
      it 'returns the buyer field description from i18n' do
        expect(presenter.buyer_description).to include('liquidation judiciaire')
      end
    end

    context 'when description does not exist' do
      it 'returns nil' do
        expect(presenter.buyer_description).to be_nil
      end
    end
  end
  ...
  describe '#mandatory_badge_class' do
    context 'when attribute is mandatory' do
      it 'returns info badge class' do
        expect(presenter.mandatory_badge_class).to eq('fr-badge--info')
      end
    end
  ...
  describe '#source_badge_class' do
    ...
    context 'when attribute is manual' do
      ...
      it 'returns warning badge class' do
        expect(presenter.source_badge_class).to eq('fr-badge--warning')
      end
    end
  end
end
