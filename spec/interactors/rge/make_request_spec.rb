...
RSpec.describe Rge::MakeRequest, type: :interactor do
  ...
  let(:endpoint_url) { "#{base_url}v3/ademe/etablissements/#{siret}/certification_rge" }
  let(:successful_response_body) { rge_success_response }
